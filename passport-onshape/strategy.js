...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://demo-c.dev.onshape.com/oauth/authorize';
  options.tokenURL = options.tokenURL || 'https://demo-c.dev.onshape.com/oauth/token';
  ...
  this.name = 'onshape';
  this._userProfileURL = options.userProfileURL || 'https://demo-c.dev.onshape.com/api/users/current';
